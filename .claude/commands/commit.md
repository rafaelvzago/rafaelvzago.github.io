...
2. Filtre arquivos protegidos (_config.yml, LICENSE, Gemfile, hugo.toml)
3. Execute checagens obrigatorias de AGENTS.md para arquivos em `content/pt-br/posts/` e `content/en/posts/` (acentuacao pt-BR / gramatica en conforme o path)
